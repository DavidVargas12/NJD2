...
if (!empty($_POST)) {
    ...
    $insertar = "INSERT INTO productos (nombre, descripcion, precio, categoria) VALUES ('$nombreProducto ', '$descripcionProducto',  '$precioProducto', '$categoriaProducto')";
    ...
    <body>
        ...
        <div class="cuadroImg">
            ...
            <form enctype="multipart/form-data" class="formulario" method="POST">
                ...
                <div class="input-group">
                    <span class="input-group-addon txtAddon"><strong>Precio </strong></span>
                    <input type="number" class="form-control" name="precio" placeholder="Ej: 12 $" required>
                </div>

                <div class="input-group">
                    <span class="input-group-addon txtAddon"><strong>Categoría </strong></span>
